...
// 补环境
window=dom.window;
// console.log(window.__proto__); //EventTarget [Window] {}
...
alert=window.alert;
// window.__proto__ = {"TEMPORARY": 0, "PERSISTENT": 1}; // 重写下面的函数原型链也可以
// window.__driver_unwrapped = undefined; // 不需要补了，结果一经一致了

// console.log(document.toString()); // [object Document]

// document.toString() ：浏览器环境和 node 环境的结果不一样
var object_toString = Object.prototype.toString;
Object.prototype.toString = function (){
    // 打印调用了tostring的对象, 看到啥就知道要补啥
    console.log(this);
...
var Function_toString = Function.prototype.toString
 Function.prototype.toString = function (){
     ...
     return Function_toString.call(this, arguments);
 }

// 赋值赋不上，不知道啥原因
// navigator.userAgent = 'Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Mobile Safari/537.36'
...
// // 使用一键上代理，可以免得一个个去写, 补完参数再注释掉
// // ps：偶尔有些问题，建议使用上面那种单独定义的的
...
//     }
// }
// //备用：console.log( '获取了：'+ '` + proxy_array[i] + `'+'的' + key + '属性: 【' + target[key] + '】,详细位置可以debugger查看');
// // 数组中放入需要代理的对象
// var proxy_array = ['document', 'navigator','location', 'history', 'screen'];
// proxy(proxy_array);
...
// 下面的目标方法 D 被exports导出，则它有一个完整的生命周期
// 59041: function(__unused_webpack_module, exports) {
"use strict";
...
// f()(s)  s还未破解
const aa = '0cd700ed22fbec94a945c204e4b26c5c';
console.log('密文1：' + D(aa));
// 以上代码在浏览器控制台可以执行，说明是环境的问题;
//      注意需要定义一个: var exports = {}, exports 在浏览器是 undefined
// 可以使用 jsdom 模拟浏览器环境

// 浏览器加密值
liulanqi_res = 'JsRbsS3lOjVDvLme561=3FaFP/Xuok4L4Q1Y9KounDMeBoVROJr0oqAiaucvIOna';
console.log('密文2: ' + liulanqi_res)
// 对同一个参数加密：浏览器上的加密值 和我们加密的结果不一致，
// 说明执行进入了错误分支，返回了错误的密文，
// 说明还有环境参数需要补
