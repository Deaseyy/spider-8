...
!function() {
    !function(t, e) {
        ...
        e(t)   // 浏览器环境：上面条件为false， 直接走这行 e(t)
        ...
        W[$_CJFA(230)] = {
            ...
            "\u0024\u005f\u0046\u0044\u0055": function(yds_guiji) {
                ...
                var t = function(t) {
                    ...
                    i;
                // }(this[$_BEHAL(343)]) // this指向window，这里从window对象获取轨迹矩阵 （猜测：捕获到我们的滑动轨迹后，赋值给了window对象）
                }(yds_guiji) // 修改为我们手动传入轨迹
                  , r = []
                  , i = []
                  , o = [];
        ...
        ne[$_CJFA(230)] = {
            ...
            "\u0024\u005f\u0043\u0043\u0042\u0076": function(t, e, n) {
                ...
                console.log('xxxxxxxxxx ========== 这里不会自动执行到 ============');
...
// 测试导出的方法
// console.log('ne:', yds_ne);
// console.log('$_CCDH:',yds_ne.prototype['$_CCDH']);
// console.log('V:', yds_V);
// console.log('gt:', yds_gt);
// console.log('P:', yds_P);
// console.log('W:', yds_W);


function get_u(){
    // u = r[$_CAIAt(754)]()  =>   r['$_CCDH']()
    u = yds_ne.prototype['$_CCDH']();
    console.log('u:', u); // length=256
    return u
}


function get_o(guiji, i){
    // i参数：i = r[$_CAHJd(69)]  =>  r['$_CJa']; re对象 => 它是 req5 请求返回的结果

    // ========= 先获取 t, e, n  ========
    // t, e, n ； e是被加密得轨迹， 可跟栈分析；
    // e = 'e--.-///./.8/(!!.Qssssssty(()))))(()*yvsssswsysstv(!!(871111111111111111g11201919E11201$l.e';
    t = 84; // 暂时写死
    n = 677; // 每次都变，但可以写死

    // l = n[$_DAAAV(913)][$_DAAAV(1059)](n[$_DAAAV(913)][$_CJJJb(1066)](), n[$_DAAAV(69)][$_CJJJb(1097)], n[$_DAAAV(69)][$_CJJJb(319)]);
    // 下面这样不行，$_FDU 函数里面从window对象获取了我们人为滑动轨迹矩阵；所以我们需要手动传轨迹矩阵进去
    // e = yds_W.prototype['$_BBEM'](yds_W.prototype['$_FDU'](), i['c'], i['s']);
    // $_FDU 函数中：滑动轨迹从window获取，模拟滑动时，需要我们手动传入；
    e = yds_W.prototype['$_BBEM'](yds_W.prototype['$_FDU'](guiji), i['c'], i['s']);
    console.log('e:', e); // 加密的轨迹

    // ========= 分析 o ===============
    o = {
        "lang": i['lang'] || 'zh-cn',
        "userresponse": yds_H(t, i['challenge']),
        "passtime": n,
        "imgload": 104, // r['$_CAGw']  // 还不知道咋来的？？？？？？？？？？？？？？？？？？
        "aa": e, // 'aa' , 被加密的滑动轨迹
        // "ep": yds_ne.prototype['$_CCCG']()  // 这样得出来得不对
        "ep": {
            "v": "7.8.9",
            "$_BIB": true,
            "me": false,
    ...
    //o[$_CAIAt(791)] = X(i[$_CAIAt(104)] + i[$_CAIAt(182)][$_CAHJd(139)](0, 32) + o[$_CAHJd(704)]);
    o['rp'] = yds_X(i['gt'] + i['challenge']['slice'](0, 32) + o['passtime']);
    o['h9s9'] = "1816378497"; // 固定值

    // // test参数 o
    // o = {
    //     "lang": "zh-cn",
    //     "userresponse": "4f4444d993c",
    //     "passtime": 677,
    //     "imgload": 86,
    //     "aa": "e--.-///./.8/(!!.Qssssssty(()))))(()*yvsssswsysstv(!!(871111111111111111g11201919E11201$l.e",
    //     "ep": {
    //         "v": "7.8.9",
    //         "$_BIB": true,
    //         "me": false,
    ...
    //     },
    //     "h9s9": "1816378497",
    //     "rp": "739d84b41694b90ddf563bbc1b006db0"
    // };
...
function get_l(o){
    // l = V[$_CAIAt(353)](gt[$_CAIAt(218)](o), r[$_CAIAt(756)]())
    // r['$_CCEc']() 就是一个随机值可以写死；
    // l = yds_V['encrypt'](yds_gt['stringify'](o), yds_ne.prototype['$_CCEc']());
    l = yds_V['encrypt'](yds_gt['stringify'](o), '51a34f9326d283de');
    console.log('l:', l);
    return l
}
...
// test
guiji = [[-43, -42, 0], [0, 0, 0], [1, 0, 79], [1, 0, 79], [2, 0, 88], [2, 0, 88], [3, 0, 95], [3, 0, 95], [5, 0, 110], [5, 0, 111], [8, 0, 119], [8, 0, 119], [11, 0, 126], [11, 0, 127], [16, 0, 134], [16, 0, 134], [20, 0, 143], [20, 0, 143], [25, 0, 152], [25, 0, 152], [32, 1, 158], [32, 1, 158], [39, 2, 166], [39, 2, 166], [44, 3, 174], [44, 3, 174], [49, 4, 184], [49, 4, 184], [55, 5, 190], [55, 5, 190], [61, 8, 198], [61, 8, 198], [69, 9, 206], [69, 9, 207], [76, 9, 214], [76, 9, 214], [84, 9, 222], [84, 9, 222], [92, 9, 230], [92, 9, 230], [99, 10, 239], [99, 10, 239], [104, 11, 246], [104, 11, 246], [106, 11, 254], [106, 11, 255], [111, 12, 262], [111, 12, 263], [113, 12, 271], [113, 12, 271], [116, 12, 279], [116, 12, 279], [118, 12, 288], [118, 12, 288], [120, 12, 294], [120, 12, 295], [124, 12, 304], [124, 12, 304], [126, 12, 310], [126, 12, 311], [129, 12, 320], [129, 12, 321], [131, 12, 326], [131, 12, 327], [133, 12, 334], [133, 12, 335], [134, 12, 342], [134, 12, 342], [137, 12, 350], [137, 12, 351], [138, 12, 358], [138, 12, 358], [139, 12, 374], [139, 12, 374], [140, 12, 382], [140, 12, 383], [141, 12, 391], [141, 12, 391], [143, 12, 406], [143, 12, 406], [144, 12, 414], [144, 12, 414], [146, 12, 430], [146, 12, 430], [147, 12, 438], [147, 12, 438], [148, 12, 446], [148, 12, 446], [149, 12, 455], [149, 12, 455], [151, 12, 462], [151, 12, 463], [152, 12, 478], [152, 12, 479], [153, 12, 487], [153, 12, 488], [154, 12, 496], [154, 12, 496], [155, 12, 511], [155, 12, 511], [156, 12, 521], [156, 12, 521], [157, 12, 527], [157, 12, 527], [158, 12, 534], [158, 12, 534], [159, 12, 542], [159, 12, 542], [160, 12, 566], [160, 12, 567], [161, 12, 590], [161, 12, 590], [162, 12, 662], [162, 12, 663], [163, 12, 735], [163, 12, 735], [165, 12, 750], [165, 12, 750], [166, 12, 814], [166, 12, 814], [167, 12, 886], [167, 12, 886], [168, 11, 895], [168, 11, 895], [169, 10, 1070], [169, 10, 1071], [169, 10, 1271]]
// req5 的请求结果，get.php
req5_res = {"gt": "019924a82c70bb123aae90d483087f94", "challenge": "2ee7d20f8cb1f7b351f352aa21149bba80", "id": "a2ee7d20f8cb1f7b351f352aa21149bba", "bg": "pictures/gt/09b7341fb/bg/7bf9e61b8.jpg", "fullbg": "pictures/gt/09b7341fb/09b7341fb.jpg", "link": "", "ypos": 43, "xpos": 0, "height": 160, "slice": "pictures/gt/09b7341fb/slice/7bf9e61b8.png", "api_server": "https://api.geetest.com", "static_servers": ["static.geetest.com/", "dn-staticdown.qbox.me/"], "mobile": true, "theme": "ant", "theme_version": "1.2.6", "template": "", "logo": true, "clean": false, "type": "multilink", "fullpage": false, "feedback": "https://www.geetest.com/contact#report", "show_delay": 250, "hide_delay": 800, "benchmark": false, "version": "6.0.9", "product": "popup", "https": true, "width": "100%", "show_voice": true, "c": [12, 58, 98, 36, 43, 95, 62, 15, 12], "s": "55563f4b", "so": 0, "i18n_labels": {"cancel": "取消", "close": "关闭验证", "error": "请重试", "fail": "请正确拼合图像", "feedback": "帮助反馈", "forbidden": "怪物吃了拼图，请重试", "loading": "加载中...", "logo": "由极验提供技术支持", "read_reversed": false, "refresh": "刷新验证", "slide": "拖动滑块完成拼图", "success": "sec 秒的速度超过 score% 的用户", "tip": "请完成下方验证", "voice": "视觉障碍"}, "gct_path": "/static/js/gct.b71a9027509bc6bcfef9fc6a196424f5.js"}
console.log('w:', get_w(guiji, req5_res));