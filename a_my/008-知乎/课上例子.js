...
// x-zse-96:2.0_vrMQh/tWbuF7tdkcuKfWBNqrblwgP1cNB387yZw7M7o1ifuWsSdg6CNrKqycMWTs
...
document = new Proxy(document, {
    ...
    get(target, property, receiver) {
        console.log("获取属性get document", property, target[property]);
        return target[property]
    }
});
...
console.log(D('eae09bf87a4ff0991632c2b3732a532f'));
console.log('/yjTP8bUXfLWd+2rMQxxZsQHvyDWgdfceaOx/jy1MpszY/pWCybVqc8pa8Xyxhos')
// 对同一个参数加密 结果不同  说明还有环境没有补到   自动吐环境技术去操作
